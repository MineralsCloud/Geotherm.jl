...
[discuss with us](https://github.com/MineralsCloud/Geotherm.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/Geotherm.jl/issues/new) or
[submit a pull request](https://github.com/MineralsCloud/Geotherm.jl/compare) with suggestions.
