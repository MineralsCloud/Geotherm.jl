...
[Geotherm](https://github.com/MineralsCloud/Geotherm.jl).
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("Geotherm")
   ```

3. Run

   ```julia-repl
   julia> using Geotherm
   ```
...
version of Geotherm, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/Geotherm.jl"
```
...
our [GitHub repository](https://github.com/MineralsCloud/Geotherm.jl)
for new releases.
Once we release a new version, you can update Geotherm by typing
